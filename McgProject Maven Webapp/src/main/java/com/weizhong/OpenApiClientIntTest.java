...
import com.weizhong.client.OpenApiClient;
import com.weizhong.client.PasswordCallback;
import com.weizhong.dto.WealthSyncClientInfoRequestDTO;
import com.weizhong.util.SignUtils;
...
public class OpenApiClientIntTest {
    ...
    //keytool -importkeystore -storepass Abcd1234 -srckeystore T*.p12 -srcstoretype PKCS12 -destkeystore webank_keystore.jks -deststoretype JKS
    // !!!!!!!!! keystore password must match p12 password !!!!!!!!!
    //keytool -import -storepass Abcd1234 -alias webank-trust -file server*.crt -keystore webank_truststore.jks
    ...
    public  void beforeClass() {
        ...
        String webankOpenApiUrlPrefix = "https://testd-capapi.webank.com/api";
